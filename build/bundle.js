...
var Game = function () {
	function Game(element, width, height) {
		...
		this.player2Score = new _Score2.default(this.width / 2 + _settings.SCORE.distance, _settings.SCORE.topDistance, _settings.SCORE.size);
		...
		this.player1 = new _Paddle2.default(this.height, this.paddleWidth, this.paddleHeight, this.padding, (this.height - this.paddleHeight) / 2, _settings.KEYS.a, _settings.KEYS.z, _settings.KEYS.x, _settings.KEYS.s);

		this.player2 = new _Paddle2.default(this.height, this.paddleWidth, this.paddleHeight, this.width - this.paddleWidth - this.padding, (this.height - this.paddleHeight) / 2, _settings.KEYS.up, _settings.KEYS.down, _settings.KEYS.left, _settings.KEYS.right);

		this.result = new _Result2.default(this.width, this.height, this.SCORE);
		...
		document.addEventListener('keydown', function (event) {
			if (event.key === _settings.KEYS.b) {
				_this.ball2.vx = _this.ball.vx, _this.ball2.vy = _this.ball.vy;
			}
		});
	}
	...
	_createClass(Game, [{
		key: 'winnerPlayer',
		value: function winnerPlayer(svg, player) {
  ...
  _createClass(Ball, [{
    ...
    value: function paddleCollision(player1, player2) {
      ...
      if (this.vx > 0) {
        ...
        if (this.x - this.radius <= _rightX // the left edge of the ball is <= right edge of the paddle
        && this.x - this.radius >= _leftX // && the left edge of the ball >= left edge paddle
        && this.y >= _topY // && the ball Y is >= the top edge of the paddle
        && this.y <= _bottomY // && the ball is <= the bottom edge of the paddle
    ...
    value: function render(svg, player1, player2) {
      ...
      var ball2 = document.createElementNS(_settings.SVG_NS, 'circle');
